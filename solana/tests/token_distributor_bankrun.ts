...
describe("token_distributor_bankrun", () => {
  ...
  before(async () => {
    ...
    console.log("使用 bankrun payer 作为拥有者:", owner.publicKey.toString());
    ...
    console.log("拥有者余额:", Number(balance) / anchor.web3.LAMPORTS_PER_SOL, "SOL");
  ...
  it("Withdraw tokens (SPL Token) - No start time set", async () => {
    ...
    try {
      ...
      console.log("初始拥有者 SOL 余额:", Number(initialOwnerSolBalance) / anchor.web3.LAMPORTS_PER_SOL, "SOL");
      ...
      console.log("创建后拥有者 SOL 余额:", Number(afterCreateSolBalance) / anchor.web3.LAMPORTS_PER_SOL, "SOL");
      ...
      console.log("提取前拥有者 SOL 余额:", Number(beforeWithdrawSolBalance) / anchor.web3.LAMPORTS_PER_SOL, "SOL");
      ...
      console.log("最终拥有者 SOL 余额:", Number(finalOwnerSolBalance) / anchor.web3.LAMPORTS_PER_SOL, "SOL");
      ...
      console.log("提取导致的 SOL 余额变化:", solBalanceChange / anchor.web3.LAMPORTS_PER_SOL, "SOL");
      ...
      console.log("净 SOL 收益（租金退款）:", netSolGain / anchor.web3.LAMPORTS_PER_SOL, "SOL");
  ...
  it("Close claim status for SPL Token", async () => {
    try {
      ...
      console.log("初始申领者 SOL 余额:", Number(initialSolBalance) / anchor.web3.LAMPORTS_PER_SOL, "SOL");
      ...
      console.log("关闭前 SOL 余额:", Number(beforeCloseSolBalance) / anchor.web3.LAMPORTS_PER_SOL, "SOL");
      ...
      console.log("最终申领者 SOL 余额:", Number(finalSolBalance) / anchor.web3.LAMPORTS_PER_SOL, "SOL");
      ...
      console.log("关闭导致的 SOL 余额变化:", solBalanceChange / anchor.web3.LAMPORTS_PER_SOL, "SOL");
